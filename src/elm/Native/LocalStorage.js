...
const _szubtsovskiy$phoenix_chrome_plugin$Native_LocalStorage = function () {
    ...
    const keys = nativeBinding(function (callback) {
        const _keys = [];
    ...
    const clear = nativeBinding(function (callback) {
        localStorage.clear();
        return callback(succeed(unit));
    });


    const storageFail = nativeBinding(function (callback) {
